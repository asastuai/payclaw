...
function notImplemented(method: string): never {
  throw new PayClawError(
    ...
    `SolanaAdapter.${method}() is not yet implemented. Coming in Phase 3.`,
  );
}
...
export class SolanaAdapter extends ChainAdapter {
  ...
  constructor(chainId: ChainId = 'solana', _rpcUrl?: string) {
    super();
...
export class SolanaDevnetAdapter extends SolanaAdapter {
  constructor(rpcUrl?: string) {
    super('solana-devnet', rpcUrl);
  }
}
